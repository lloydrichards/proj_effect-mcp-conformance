...
const JsonSchema202012Registration = Layer.effectDiscard(
  McpServer.McpServer.use((mcp) =>
    mcp.addTool({
      tool: JsonSchema202012Tool,
      annotations: Context.empty(),
      handle: jsonSchema202012Handler,
    }),
  ),
);

const ScenarioLive = JsonSchema202012Registration.pipe(
  Layer.provideMerge(server("json-schema-2020-12")),
);
